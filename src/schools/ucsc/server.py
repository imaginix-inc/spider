...
async def parse_course(json_data):
    ...
    course = Course(
        ...
        enrolled_count=primary_section.get("enrl_total", 0),
        max_enroll=primary_section.get("capacity", 0),
        waitlisted_count=primary_section.get("waitlist_total", 0),
        max_waitlist=primary_section.get("waitlist_capacity", 0),
